...
<railo-configuration password="1495c0c0f8071724059736011e0aafe7ec85e27e7fcedc15bf97f22305467438" version="2.0">
  <cfabort/>
...
<!--	or ask your database distributor 																-->
	...
	<data-sources>
	<data-source allow="511" blob="false" class="org.gjt.mm.mysql.Driver" clob="false" connectionTimeout="1" custom="characterEncoding=UTF-8&amp;useUnicode=true" database="tigercms" dsn="jdbc:mysql://{host}:{port}/{database}" host="localhost" metaCacheTimeout="60000" name="tigercms" password="encrypted:d5d45f960f0bb8bd86d8dd2b54b540cc2b8b7aed4f94ef0ba5f84cca02ceb4a5" port="3306" username="tbankert"/>
  </data-sources>
...
<extensions>
    <provider url="http://www.andyjarrett.co.uk/RailoExtensionProvider/ExtensionProvider.cfc"/>
  <extension author="Ext by Andy Jarrett.&lt;br/&gt;CFPOI by Matt Woodward" category="Application" codename="" config="{'MIXED':{},'STEPS':[]}" created="{ts '2009-02-23 17:00:00'}" description="cfspreadhsheet tag &amp;amp; functions" documentation="http://code.google.com/p/cfpoi/w/list" forum="" id="10EEC23A-0779-4068-9507A9C5ED4A8641" image="http://www.gstatic.com/codesite/ph/images/defaultlogo.png" label="&amp;lt;cfspreadhsheet/&amp;gt; tag &amp;amp; functions" mailinglist="" name="CFPOI" network="" provider="http://www.andyjarrett.co.uk/RailoExtensionProvider/ExtensionProvider.cfc" support="https://github.com/andyj/RailoExtensionProvider/issues" type="web" version="version 1 alpha1" video=""/>
  </extensions>
</railo-configuration>
